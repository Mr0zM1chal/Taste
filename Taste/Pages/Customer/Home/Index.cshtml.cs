...
namespace Taste.Pages.Customer.Home
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            if(claim != null)
            {
                int shopingCartCount = _unitOfWork.ShoppingCart.GetAll(u=>u.ApplicationUserId == claim.Value).ToList().Count;
                HttpContext.Session.SetInt32(SD.ShopingCart, shopingCartCount);
            }
